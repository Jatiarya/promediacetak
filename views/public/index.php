  ...
  <main class="beranda bg-[#005EFF] w-[1140px] h-[600px] mx-auto mt-10 rounded-[10px] flex justify-between p-10">
      <div class="container flex justify-between items-center gap-10 ">
          <div class="left-content ">
              ...
              <a href="?page=pesan"
                  class="mt-4 px-4 py-2 bg-[#FFA500] text-white rounded-[10px] hover:bg-blue-600">Pesan
                  Jasa</a>
          </div>
          <div class="right-content">
              <div class="container-card flex gap-4">
                  <div class="card bg-white w-[125px] h-[363px] rounded-[10px]">
                      <img src="../..//img/main (1).jpg" alt="" style="height: 100%; width: 100%;">
                  </div>
                  <div class="card bg-white w-[125px] h-[363px] rounded-[10px]">
                      <img src="../..//img/main (2).jpg" alt="" style="height: 100%; width: 100%;">
                  </div>
                  <div class="card bg-white w-[125px] h-[363px] rounded-[10px]">
                      <img src="../..//img/main (3).jpg" alt="" style="height: 100%; width: 100%;">
                  </div>
              </div>
          </div>
      </div>
  </main>
  <div class="layanan mx-auto flex flex-col items-center mt-10">
      ...
      <div class="grid grid-cols-4 gap-6 mt-10">
          <div class="card w-[260px] h-[600px] bg-[#005EFF] p-4 rounded-[10px] flex flex-col items-center">
              ...
              <a href="?page=pesan"
                  class="p-2 bg-[#FFA500] relative bottom-[-40px] rounded-[5px] items-center text-white">Pesan
                  Jasa</a>
          </div>
          <div class="card w-[260px] h-[600px] bg-[#005EFF] p-4 rounded-[10px] flex flex-col items-center">
  ...
  <div class="testimoni mx-auto flex flex-col items-center mt-10">
